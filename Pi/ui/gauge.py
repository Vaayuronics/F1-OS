...
class GaugeWidget(QWidget):
    ...
    def _drawThrottleArc(self, painter):
        ...
        if self.throttle > 0:
            ...
            gradient.setColorAt(0.1, QColor(255, 165, 0))   # Orange at 25% of arc (0.25 * 0.75)
            gradient.setColorAt(0.3, QColor(255, 255, 0))    # Yellow at 50% of arc (0.5 * 0.75)
            gradient.setColorAt(1.0, QColor(0, 255, 0))       # Green at end (will be at start of arc)
